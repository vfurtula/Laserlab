...
class Run_CM110(QMainWindow):
	...
	def set_run(self):
		...
		self.timer.stop()
		self.get_thread=Run_CM110_Thread(self.arr_cm110,dwelltime,dwell_ard,self.avg_pts,file_txt,file_hdf5,self.timestr,self.analogref,self.inst_list,self.arr_smc100,self.cb_cm110,self.cb_smc100,self.channel)
